...
#define DEFAULT_LCD_BRIGHTNESS 500
#define MIN_STROBE_PERIOD      20

static const char *TAG = "ALEXA/DISPLAY";
...
void display_wake(bool pause_timer)
{
    reset_timer(hdl_display_timer, config_get_int("display_timeout", DEFAULT_DISPLAY_TIMEOUT), pause_timer);
