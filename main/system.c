...
static const char *TAG = "ALEXA/SYSTEM";
...
void restart_delayed(void)
{
    ...
    char restart_msg[40];
    snprintf(restart_msg, sizeof(restart_msg), "Restart za %" PRIu32 " sekund", delay);
    ui_display_text(NULL, NULL, restart_msg, NULL, NULL);
