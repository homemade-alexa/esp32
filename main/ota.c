...
static const char *TAG = "ALEXA/OTA";
...
void ota_task(void *data)
{
    ...
    ui_display_text(NULL, NULL, "Aktualizacja wykonana", NULL, NULL);
    restart_delayed();
err:
    ...
    ui_display_text(NULL, NULL, "Aktualizacja nie powiodła się", NULL, NULL);
    restart_delayed();
    vTaskDelete(NULL);
}
...
{
    ui_display_text(NULL, NULL, "Startuję aktualizację", NULL, NULL);
    display_wake(true);
